        ...
        {!loading && caseRecord && (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="p-5 rounded-xl border border-border bg-gradient-to-r from-surface-elevated/60 to-surface/40 backdrop-blur-sm relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-text-muted mt-0.5">
                        Multi-vector heuristic attribution, NLP intent modeling, and SHA-256 evidence hashing committed.
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 text-xs font-mono text-text-muted">
                    <span className="text-[11px] uppercase tracking-wider">Evidence Hash:</span>
                    <code className="text-accent bg-background px-2 py-0.5 rounded border border-border">
                      {caseRecord.sha256.slice(0, 12)}...
                    </code>
                  </div>
                </div>
              </div>

              {/* Forensic Execution Stages - Completed State */}
              <div className="space-y-3">
                <div className="text-xs font-mono uppercase tracking-wider text-text-muted font-semibold">
                  Forensic Pipeline Verification Stages
                </div>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                  {/* Stage 01 */}
                  <div className="p-4 rounded-xl border border-border bg-surface-elevated/40 relative overflow-hidden">
                    <div className="flex items-center gap-2 mb-2">
                      <Badge variant="outline" className="text-[9px] font-mono font-bold">
                        STAGE 01
                      </Badge>
                      <Check className="w-3.5 h-3.5 text-success" />
                      <span className="text-[10px] font-mono text-success font-medium">Ingested</span>
                    </div>
                    <div className="text-xs font-bold text-foreground mb-1">
                      DOM & MIME Extraction
                    </div>
                    <div className="text-[11px] text-text-muted leading-relaxed">
                      RFC 5322 headers, unmasked hyperlink anchors & UTF-8 body decoded.
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-xl border border-border bg-surface-elevated/40 relative overflow-hidden">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Check className="w-3.5 h-3.5 text-success" />
                      <span className="text-[10px] font-mono text-success font-medium">Verified</span>
                    </div>
                    <div className="text-xs font-bold text-foreground mb-1">
                      Heuristics & Homoglyphs
                    </div>
                    <div className="text-[11px] text-text-muted leading-relaxed">
                      Punycode spoofing, leetspeak typosquatting & cryptographic SPF/DKIM flags.
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-xl border border-border bg-surface-elevated/40 relative overflow-hidden">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Check className="w-3.5 h-3.5 text-success" />
                      <span className="text-[10px] font-mono text-success font-medium">Evaluated</span>
                    </div>
                    <div className="text-xs font-bold text-foreground mb-1">
                      BERT NLP & CTI Feeds
                    </div>
                    <div className="text-[11px] text-text-muted leading-relaxed">
                      Deep cognitive urgency intent, VIP impersonation & cyber threat intelligence.
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-xl border border-border bg-surface-elevated/40 relative overflow-hidden">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Check className="w-3.5 h-3.5 text-success" />
                      <span className="text-[10px] font-mono text-success font-medium">Committed</span>
                    </div>
                    <div className="text-xs font-bold text-foreground mb-1">
                      Vault Sealing & Ledger
                    </div>
                    <div className="text-[11px] text-text-muted leading-relaxed">
                      Cryptographic evidence integrity sealing & immutable SQLite audit commit.
                    </div>
                  </div>
                </div>
              </div>
