...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("bg-surface-elevated border-b border-table-border", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-table-border bg-surface-muted font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, selected, ...props }, ref) => (
  <tr
    ...
    className={cn(
      ...
      selected && "bg-table-row-selected",
      className
    )}
    {...props}
  />
